...
<body>
    ...
    <div>
        ...
        <h1><center><span class="aku">&nbsp; Soal 1 &nbsp; </span></center></h1>
        <img src="img/put.jpg" height="45" alt="">
    </div>
            ...
            <div class="offset-lg-2 col-lg-8">
                <form action="" method="GET">
                        <div class="mb-3">
                            <div class="row">
                                <div class="col-lg-8">
                                    <h6> <label class="class-lg-8"for="" >Nama  &nbsp;&nbsp&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp; : </label>
                                        <input type="text" name="nama" id="nama1" class= "form-control-5" placeholder="Masukkan nama ..."> 
                                    </h6>
                                </div>
